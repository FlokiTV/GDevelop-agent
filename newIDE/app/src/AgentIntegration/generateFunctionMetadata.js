...
// Node-only code generator. It derives AgentIntegration function metadata from the
// native EditorFunctions implementations instead of duplicating their schemas
// by hand. Run with:
//   node src/AgentIntegration/generateFunctionMetadata.js
// Check for stale generated metadata with:
//   node src/AgentIntegration/generateFunctionMetadata.js --check
...
const output = `// @flow\n// AUTO-GENERATED by AgentIntegration/generateFunctionMetadata.js. Do not edit by hand.\n\nexport const generatedFunctionMetadata: Array<any> = ${serialized};\n`;
...
if (checkOnly) {
  ...
  if (existing !== output) {
    console.error(
      'FunctionMetadata.generated.js is stale. Run node src/AgentIntegration/generateFunctionMetadata.js.'
    );
    process.exitCode = 1;
  } else {
  ...
  console.log(
    `Generated ${entries.length} AgentIntegration function metadata entries.`
  );
